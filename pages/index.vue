...
<!--                <a href="#" class="text-sm font-medium text-white hover:text-gray-100">Sign in</a>-->
                <a href="#" class="text-sm font-medium text-white hover:text-gray-100">{{tg.initDataUnsafe?.user.first_name}} {{tg.initDataUnsafe?.user.last_name}}</a>
              </div>
            </div>
          </div>
...
<!--&lt;!&ndash;                      <MagnifyingGlassIcon class="h-6 w-6" aria-hidden="true" />&ndash;&gt;-->
<!--                    </a>-->
                  </div>
...
<!--&lt;!&ndash;                          <ShoppingBagIcon class="h-6 w-6 flex-shrink-0 text-white" aria-hidden="true" />&ndash;&gt;-->
